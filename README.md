...
- Open engineering work is tracked in `issues/`.
...
- Current merged statement coverage: `99.4%`.
...
- A historical audit of the original JavaScript-side test corpus is tracked in [issues/0020-test-coverage-and-original-test-audit.md](./issues/0020-test-coverage-and-original-test-audit.md).
